...
function Footer() {
  ...
  return (
    <div className='footer'>
      <div className="left">
        <div className="links">
          <Link href="https://github.com/rhemanth399/Typing-Test" underline="none" color="inherit">
            <GitHubIcon fontSize="large" />
          </Link>
          <Link href="#LinkedIn" underline="none" color="inherit">
            <LinkedInIcon fontSize="large" />
          </Link>
          <Link href="#facebook" underline="none" color="inherit">
            <FacebookIcon fontSize="large" />
          </Link>
          <Link href="https://www.instagram.com/r_hemanth_icon/" underline="none" color="inherit">
      ...
      <div className="center">
        <p>Developed by <b>Hemanth R</b> </p>
      </div>
      <div className="right">
